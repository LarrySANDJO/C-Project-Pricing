...
int main()
{
    ...
    // Arbre Leisen-Reimer (meilleure convergence)
    BinomialTreePricer tree_lr(europeanCall, S0, r, b, sigma, tree_steps, false,
                               BinomialTreePricer::TreeType::LeisenReimer);
    print_price_result("Arbre Binomial Leisen-Reimer", tree_lr.price());
    ...
    std::cout << "Fonctionnalités implémentées :" << std::endl;
    std::cout << "  • Options européennes (Call/Put)" << std::endl;
    std::cout << "  • Options américaines (exercise anticipé)" << std::endl;
    std::cout << "  • Options asiatiques (arithmétique/géométrique)" << std::endl;
    std::cout << "  • Options lookback (fixe/flottant)" << std::endl;
    std::cout << "  • Options barrières (in/out, up/down)" << std::endl;
    std::cout << "  • Options digitales (binaires)" << std::endl;
    std::cout << "  • Options power" << std::endl;
    std::cout << "\nMéthodes de pricing :" << std::endl;
    std::cout << "  • Black-Scholes analytique" << std::endl;
    std::cout << "  • Monte Carlo (variables antithétiques)" << std::endl;
    std::cout << "  • Arbres binomiaux (CRR, JR, Leisen-Reimer)" << std::endl;
    std::cout << "  • Différences finies (Crank-Nicolson)" << std::endl;
    std::cout << "\nStratégies de couverture :" << std::endl;
    std::cout << "  • Delta-hedging avec rebalancement" << std::endl;
    std::cout << "  • Analyse d'erreur de réplication" << std::endl;
    std::cout << "  • Export des stratégies (CSV)" << std::endl;
    std::cout << "\nGreeks calculés :" << std::endl;
    std::cout << "  • Delta, Gamma, Vega, Theta, Rho" << std::endl;
